import {PRODUCT_CREATE_RESET, PRODUCT_CREATE_FAIL, PRODUCT_CREATE_REQUEST, 
    PRODUCT_CREATE_SUCCESS, PRODUCT_DETAILS_FAIL, 
    PRODUCT_DETAILS_REQUEST, PRODUCT_DETAILS_SUCCESS, PRODUCT_LIST_FAIL, 
    PRODUCT_LIST_REQUEST, PRODUCT_LIST_SUCCESS, PRODUCT_UPDATE_SUCCESS, 
    PRODUCT_UPDATE_RESET, PRODUCT_UPDATE_FAIL, PRODUCT_UPDATE_REQUEST, 
...
export const productUpdateReducers=(state={},action)=>{
    ...
    switch(action.type){
        ...
        case PRODUCT_UPDATE_SUCCESS:
            return {loadinag:false,success:true};
